{ $OmniXML: OmniXML/OmniXMLConf.pas,v 1.3 2005/11/08 07:58:36 mremec Exp $ }
(*******************************************************************************
...
type TxmlConf=class
  ...
  public
    ...
    function ReadWideString(Section: String; Ident: String; Default: WideString): WideString;
    ...
    procedure WriteWideString(Section: String; Ident: String; Value: WideString);
...
function TxmlConf.ReadWideString(Section, Ident:String; Default: WideString): WideString;
var dataNode: IXMLNode;
begin
...
procedure TxmlConf.WriteWideString(Section, Ident:String; Value: WideString);
begin
  WriteIdentNode(Section, Ident, Value);
end;
