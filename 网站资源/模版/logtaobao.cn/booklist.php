...
$template = new H2o('template/templates/booklist.html', array(
...
$category=SQL_getCatById($cid);
$books=SQL_getNewBookListByCat($cid,($page-1)*$pagesize,$pagesize);
...
echo $template->render(array(
    'books' => $books,
    'hotbooks' => SQL_getHotBookListByCat($cid,0,20),
	"book_count" => $total,
	'show_prev' => $show_prev,
    'show_next' => $show_next,
	'prev' => $page - 1,
